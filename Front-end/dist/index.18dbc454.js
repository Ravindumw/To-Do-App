...
taskContainerElm.addEventListener("click", (e)=>{
    if (e.target?.classList.contains("delete")) // todo : delete the task in back-end
    // if success
    e.target.closest("li").remove();
    else if (e.target?.tagName === "INPUT") e.preventDefault();
});
let taskId = 0;
...
},{}]},["lv1zm","1SICI"], "1SICI", "parcelRequire8d29")
